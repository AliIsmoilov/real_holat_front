...
export const HOME_PAGE_CONTENT = {
  ...
  hero: {
    ...
    description:
      '«Realholat.uz Решаем вместе» — Фиксируйте проблемы в школах, добавляйте фото и отправляйте обращения через карту или поиск  напрямую государственным органам всего за несколько секунд. Зарабатывайте молнии, открывайте новые уровни персонажа и получайте бонусы за активное участие!',
    primaryAction: {
